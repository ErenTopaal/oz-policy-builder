...
<Cards>
  <Card title="Guides" href="/docs/guides" description="Recipes for synthesizing from your own transaction, installing on a smart account, integrating into a dapp, hosting your own MCP server, troubleshooting." />
</Cards>
